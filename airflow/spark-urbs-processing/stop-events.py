...
query = """(
            select v.cod_linha, v.veic as vehicle, v.event_timestamp as stop_timestamp, v.year, v.month, v.day, v.hour , v.lat as latitude, v.lon as longitude, date_format(cast(v.event_timestamp as timestamp), '%T') as event_time
            from veiculos v 
