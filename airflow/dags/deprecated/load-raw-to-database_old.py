...
for t in config['etl_tasks']:
    ...
    for i in range(delta.days + 1):
        ...
        load_to_pg = '/spark/bin/spark-submit --master local[*] --driver-class-path ' \
                        '/dataprocessing/jars/postgresql-42.2.8.jar  /dataprocessing/load_to_postgresql.py -f {} -t {}' \
        ...
        spark_load_to_pg.append(DockerOperator(
            ...
            volumes=['/mestrado/master-thesis/airflow/dataprocessing:/dataprocessing'
